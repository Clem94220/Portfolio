            ...
            <div className="relative z-10">
                ...
                <div className="flex items-center gap-4 mb-4">
                    <SafeImage
                        ...
                        fallbackClassName="w-16 h-16 rounded-full bg-white/[0.04] ring-2 ring-accent/30 group-hover:ring-accent/60 transition-all flex items-center justify-center flex-shrink-0"
