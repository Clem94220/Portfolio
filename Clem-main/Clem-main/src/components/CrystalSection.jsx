    ...
    return (
        <div className="space-y-6">
            ...
            <motion.div
                ...
                className="crystal-card shine-card card-spotlight p-6 sm:p-7"
            >
                <div className="relative z-10 space-y-5">
                    <div className="flex items-center gap-4">
                        ...
                        >
                            <SafeImage
                                ...
                                fallbackClassName="w-14 h-14 rounded-2xl bg-white/[0.04] flex items-center justify-center"
                                fallbackLabel="Crystal Solution"
                                loading="lazy"
                                decoding="async"
                            />
                        </motion.div>
                    ...
                    <div className="flex flex-wrap gap-3">
                        <motion.a
                            ...
                            style={{ boxShadow: '0 12px 30px rgba(255,255,255,0.08)' }}
                        >
                ...
                {CRYSTAL_FEATURES.map((feature) => {
                    ...
                    return (
                        <motion.article
                            ...
                            className="crystal-card card-spotlight p-6"
                        >
                ...
                >
                    {CRYSTAL_PRICING.map((pricing) => (
                        <motion.article
                            ...
                            className="crystal-card card-spotlight p-5"
                        >
