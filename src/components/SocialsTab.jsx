...
/* ── Social links ── */
const LINKS = [
    { icon: SiDiscord, label: 'Discord Server', handle: 'Join us', url: 'https://discord.gg/evhpge7UCE', color: '#5865f2' },
    { icon: FaSpotify, label: 'Spotify', handle: 'Clem', url: 'https://open.spotify.com/user/31nasvp5d3r2h2n2ivecywukzmje', color: '#1db954' },
