...
export default function GamingSection() {
    ...
    const gamingData = GAMING.map((entry, index) => {
        const trans = t.gaming.entries[index];
        return {
            ...entry,
            title: trans ? trans.title : entry.title,
            detail: trans ? trans.detail : entry.detail,
        };
    });
    ...
    return (
        <div className="space-y-6">
            <SectionHeading
                title={t.gaming.headingTitle}
                description={t.gaming.headingDesc}
            />
