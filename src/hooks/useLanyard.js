...
const DEFAULT_USER_ID = '1145418060010901636';
 ...
 */
export function useLanyard(userId = DEFAULT_USER_ID) {
    ...
    const pollRest = useCallback(async () => {
        if (!userId || pollingInFlightRef.current) return;
    ...
    }, [clearReconnectTimeout, startPolling, stopHeartbeat, stopPolling, stopSocket, userId]);
    ...
    }, [clearReconnectTimeout, connectWs, stopPolling, stopSocket, userId]);
